...
from weixin_article_spider.config import PROXY_POOL_URL, MAX_COUNT, KEYWORD, MONGO_DB, MONGO_URI
...
def parse_index(html):
    ...
    # 获取到每个微信文章的<a>标签，里面存储了微信文章的跳转连接，items是一个<a>标签列表
    for item in items:
